    ...
    return (
        <>
            ...
            <div className="post-box">
                <p className="fw-bold text-20">Related News</p>
                <div className="col-12 mb-3">
                    <div className="post-overflow-y">
                        <div className="list-box-related">
                            <div className="content1">
                                <div className="">
                                    <span className='date'>2022. 10-15</span>
                                    <p className='author'>Created by Long</p>
                                    <div className="list-post-img1" style={{ backgroundImage: `url(${hinh2})`, backgroundPosition: `center`, backgroundSize: `cover` }}></div>
                                </div>
                                <p className='title-list mt-2'>List Post Name</p>
