    ...
    return (
        <>
            <div className="post-box">
                <p className="fw-bold text-20">Course Store</p>
                <div className="mt-3 d-flex justify-content-between post-overflow-x">
                    <div className="course-box">
                        <div className="course-img" style={{ backgroundImage: `url(${hinh3})`, backgroundPosition: `center`, backgroundSize: `cover`, backgroundRepeat: `no-repeat` }} ></div>
